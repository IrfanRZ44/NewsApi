...
import id.telkomsel.merchant.databinding.FragmentRegisterMerchantBinding
import id.telkomsel.merchant.utils.Constant
import id.telkomsel.merchant.utils.adapter.dismissKeyboard

class RegisterMerchantFragment : BaseFragmentBind<FragmentRegisterMerchantBinding>(){
    override fun getLayoutResource(): Int = R.layout.fragment_register_merchant
    lateinit var viewModel: RegisterMerchantViewModel
