...
import id.telkomsel.merchant.databinding.FragmentVerifyRegisterMerchantBinding
...
class VerifyRegisterMerchantFragment : BaseFragmentBind<FragmentVerifyRegisterMerchantBinding>(){
    override fun getLayoutResource(): Int = R.layout.fragment_verify_register_merchant
    lateinit var viewModel: VerifyRegisterMerchantViewModel
    ...
    override fun myCodeHere() {
        ...
        try {
            viewModel =
                VerifyRegisterMerchantViewModel(
                    activity,
                    bind.progressTimer,
                    bind.etText1,
                    bind.etText2,
