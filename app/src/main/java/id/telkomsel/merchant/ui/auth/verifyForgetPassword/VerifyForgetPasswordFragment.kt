package id.telkomsel.merchant.ui.auth.verifyForgetPassword
...
import id.telkomsel.merchant.databinding.FragmentVerifyForgetPasswordBinding
...
class VerifyForgetPasswordFragment : BaseFragmentBind<FragmentVerifyForgetPasswordBinding>(){
    ...
    override fun myCodeHere() {
        ...
        try {
            ...
            viewModel.dataMerchant = this.arguments?.getParcelable(Constant.reffMerchant)?:throw Exception("Error, mohon lakukan lupa password ulang")
            viewModel.noHp.value = viewModel.dataMerchant.no_hp_merchant
