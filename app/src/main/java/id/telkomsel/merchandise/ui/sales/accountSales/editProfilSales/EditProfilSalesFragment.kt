...
import id.telkomsel.merchandise.databinding.FragmentEditProfilSalesBinding
...
class EditProfilSalesFragment : BaseFragmentBind<FragmentEditProfilSalesBinding>(){
    override fun getLayoutResource(): Int = R.layout.fragment_edit_profil_sales
    lateinit var viewModel: EditProfilSalesViewModel
    ...
    private fun init(savedInstanceState: Bundle?){
        ...
        viewModel = EditProfilSalesViewModel(savedData, activity, findNavController(),
            bind.spinnerKategori,
            bind.spinnerProvinsi, bind.spinnerKabupaten, bind.spinnerKecamatan, bind.spinnerKelurahan,
            bind.etNamaSales, bind.etAlamatSales, bind.etTitikLokasi, bind.etTglPeresmian,
            bind.etCluster, bind.etNoHpSales, bind.etNoWaSales,
        ...
        viewModel.dataSales = savedData.getDataSales()
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == Activity.RESULT_OK && !username.isNullOrEmpty() && act != null){
                ...
                imagePath?.let { RetrofitUtils.uploadFoto(Constant.dataModelFotoWajah,
                    Constant.folderFotoWajah, nameFile, username, imagePath, act) }
            }
        }
    }
}