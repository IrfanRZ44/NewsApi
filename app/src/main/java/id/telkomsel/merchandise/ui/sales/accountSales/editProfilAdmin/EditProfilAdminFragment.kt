...
import id.telkomsel.merchandise.databinding.FragmentEditProfilAdminBinding
...
class EditProfilAdminFragment : BaseFragmentBind<FragmentEditProfilAdminBinding>(){
    ...
    private fun init(savedInstanceState: Bundle?){
        ...
        viewModel = EditProfilAdminViewModel(activity, findNavController(),
            ...
            bind.etNamaSales, bind.etAlamatSales, bind.etTitikLokasi,
    ...
    private fun onClick(){
        bind.etNoWaPemilik.editText?.setOnEditorActionListener(TextView.OnEditorActionListener { _, actionId, _ ->
            if (actionId == EditorInfo.IME_ACTION_DONE) {
                viewModel.onClickRegisterSales()
