...
import com.exomatik.ballighadmin.ui.main.dashboard.DashboardFragment
...
import com.exomatik.ballighadmin.utils.Constant.dashboard
...
class MainFragment : BaseFragment() {
    ...
    private fun setupViewPager(pager: ViewPager) {
        ...
        tabs.getTabAt(0)?.icon = resources.getDrawable(R.drawable.ic_home_white)
        tabs.getTabAt(1)?.icon = resources.getDrawable(R.drawable.ic_lembaga_dakwah_gray)
        tabs.getTabAt(2)?.icon = resources.getDrawable(R.drawable.ic_masjid_gray)
        tabs.getTabAt(3)?.icon = resources.getDrawable(R.drawable.ic_muballigh_akun_gray)
        tabs.getTabAt(4)?.icon = resources.getDrawable(R.drawable.ic_chat_gray)
        ...
        tabs.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            override fun onTabSelected(tab: TabLayout.Tab) {
                when (tab.position) {
                    ...
                    1 -> {
                        tabs.getTabAt(0)?.icon = resources.getDrawable(R.drawable.ic_home_gray)
                        tabs.getTabAt(1)?.icon = resources.getDrawable(R.drawable.ic_lembaga_dakwah_white)
                        tabs.getTabAt(2)?.icon = resources.getDrawable(R.drawable.ic_masjid_gray)
                        tabs.getTabAt(3)?.icon = resources.getDrawable(R.drawable.ic_muballigh_akun_gray)
                        tabs.getTabAt(4)?.icon = resources.getDrawable(R.drawable.ic_chat_gray)
                    }
                    2 -> {
                        tabs.getTabAt(0)?.icon = resources.getDrawable(R.drawable.ic_home_gray)
                        tabs.getTabAt(1)?.icon = resources.getDrawable(R.drawable.ic_lembaga_dakwah_gray)
                        tabs.getTabAt(2)?.icon = resources.getDrawable(R.drawable.ic_masjid_white)
                        tabs.getTabAt(3)?.icon = resources.getDrawable(R.drawable.ic_muballigh_akun_gray)
                        tabs.getTabAt(4)?.icon = resources.getDrawable(R.drawable.ic_chat_gray)
                    }
                    3 -> {
                        ...
                        tabs.getTabAt(1)?.icon = resources.getDrawable(R.drawable.ic_lembaga_dakwah_gray)
                        tabs.getTabAt(2)?.icon = resources.getDrawable(R.drawable.ic_masjid_gray)
                        tabs.getTabAt(3)?.icon = resources.getDrawable(R.drawable.ic_muballigh_akun_white)
                        tabs.getTabAt(4)?.icon = resources.getDrawable(R.drawable.ic_chat_gray)
                    }
                    else -> {
                        tabs.getTabAt(0)?.icon = resources.getDrawable(R.drawable.ic_home_gray)
                        ...
                        tabs.getTabAt(2)?.icon = resources.getDrawable(R.drawable.ic_masjid_gray)
                        tabs.getTabAt(3)?.icon = resources.getDrawable(R.drawable.ic_muballigh_akun_gray)
                        tabs.getTabAt(4)?.icon = resources.getDrawable(R.drawable.ic_chat_white)
                    }
                }
            }
