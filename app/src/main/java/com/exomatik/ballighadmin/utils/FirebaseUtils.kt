...
import com.exomatik.ballighadmin.services.notification.APIService
import com.exomatik.ballighadmin.services.notification.Common
...
import com.exomatik.ballighadmin.utils.Constant.referenceNotif
...
//    }
    ...
    fun refreshDataUserChatWith3Child(
        reference: String,
        child: String,
        eventListener: ValueEventListener
    ) {
