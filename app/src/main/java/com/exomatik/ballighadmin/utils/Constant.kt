...
object Constant {
    ...
    const val referenceUsername = "username"
    const val referenceChat = "Chat"
    const val referenceRuangChat = "RuangChat"
    const val chatMBtoAdmin = "chatMBtoAdmin"
    const val chatMJtoAdmin = "chatMJtoAdmin"
    const val chatLDtoAdmin = "chatLDtoAdmin"
    ...
    const val defaultUsernameAdmin = "AdminBalligh"
    const val admin = "Admin"
    const val akunLD = "Lembaga Dakwah"
    const val akunMB = "Muballigh"
    const val akunMJ = "Pengurus Masjid"
